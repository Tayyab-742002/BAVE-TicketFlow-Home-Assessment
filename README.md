...
- **A Customer requesting a ticket they don't own gets `404`, not `403`** — avoids confirming a ticket's existence to someone who can't see it (OWASP object-level-authorization guidance).
